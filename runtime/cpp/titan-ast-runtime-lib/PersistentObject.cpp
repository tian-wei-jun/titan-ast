...
BuildAutomataResult PersistentObject::initByPersistentData(PersistentData *persistentData) {
...
BuildAutomataResult PersistentObject::initAstAutomata() {
  GetAstAutomataTypeResult getAstAutomataTypeResult = persistentData->getAstAutomataTypeByInputStream();
...
BuildAutomataResult PersistentObject::initFollowFilterBacktrackingBottomUpAstAutomata() {
  BuildAutomataResult buildAutomataResult;
...
BuildAutomataResult PersistentObject::initNonterminalFollowMap() {
  GetNonterminalFollowMapByInputStreamResult getNonterminalFollowMapByInputStreamResult = persistentData->getNonterminalFollowMapByInputStream();
...
BuildAutomataResult PersistentObject::initEofGrammar() {
  GetGrammarByInputStreamResult getGrammarByInputStreamResult = persistentData->getGrammarByInputStream();
...
BuildAutomataResult PersistentObject::initAstDfa() {
  GetSyntaxDfaByInputStreamResult getSyntaxDfaByInputStreamResult = persistentData->getSyntaxDfaByInputStream();
...
BuildAutomataResult PersistentObject::initProductionRules() const {
  GetProductionRulesByInputStreamResult getProductionRulesByInputStreamResult = persistentData->getProductionRulesByInputStream();
...
BuildAutomataResult PersistentObject::initTokenDfa() {
  GetTokenDfaByInputStreamResult getTokenDfaByInputStreamResult = persistentData->getTokenDfaByInputStream ();
...
BuildAutomataResult PersistentObject::initKeyWordAutomata() {
  GetKeyWordAutomataByInputStreamResult getKeyWordAutomataByInputStreamResult = persistentData->getKeyWordAutomataByInputStream();
...
BuildAutomataResult PersistentObject::initGrammars() const {
  GetGrammarsByInputStreamResult getGrammarsByInputStreamResult = persistentData->getGrammarsByInputStream();
...
BuildAutomataResult PersistentObject::initStringPool() const {
  GetStringPoolByInputStreamResult getStringPoolByInputStreamResult = persistentData->getStringPoolByInputStream();
